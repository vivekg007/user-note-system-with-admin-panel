<?php
	...
	$sql = "UPDATE visiters SET hits = hits+1 WHERE id = 0";
				...
				<div class="card-group myShadow">
					<div class="card rounded-left p-4" style="flex-grow: 1.4;">
						...
						<div class="card justify-content-center rounded-right myColor p-4">
							...
							<button class="btn btn-outline-light btn-lg align-self-center font-weight-bolder mt-4 myLinkBtn" id="register-link">Sign Up
							</button>
						</div>
					</div>					
				</div>
			...
			<div class="col-lg-10 my-auto">
				<div class="card-group myShadow">
					<div class="card justify-content-center rounded-left myColor p-4">
							...
							<button class="btn btn-outline-light btn-lg align-self-center font-weight-bolder mt-4 myLinkBtn" id="login-link">Sign In
							</button>
						</div>
			...
			<div class="col-lg-10 my-auto">
				<div class="card-group myShadow">
					<div class="card justify-content-center rounded-left myColor p-4">
							...
							<button class="btn btn-outline-light btn-lg align-self-center font-weight-bolder mt-4 myLinkBtn" id="back-link">Back
							</button>
						</div>
					<div class="card rounded-right p-4" style="flex-grow: 1.4;">
						<h1 class="text-center font-weight-bold text-primary">
						...
						<p class="lead text-center text-secondary">
							To Reset Your password, enter the registered e-mail address and we will send you the reset instructions on your e-mail!
						</p>
